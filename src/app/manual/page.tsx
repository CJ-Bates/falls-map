  ...
  return (
    <main className="hero-radial min-h-[100svh] w-full pb-16">
      ...
      <div className="px-6 mx-auto max-w-3xl space-y-4 text-[#F0E2C2]">
        {/* Quick start — first three things every guest should do */}
        <section className="ios-glass rounded-3xl p-5">
          ...
          <ol className="space-y-2.5 text-[14px] text-[#F0E2C2]/85 leading-relaxed list-decimal list-inside">
            <li>
              ...
              Tap the <em>Install as app</em> chip at the top of the home page so
              the property map, trails, and wifi info work even when cell drops.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Find your cabin\u2019s page.</span>{" "}
              Each cabin has its own welcome page with wifi + photos \u2014
              <Link href="/" className="text-[#cdac7d] underline ml-1">links below</Link>.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Need anything?</span>{" "}
              Tap <em>Send feedback</em> on the home page \u2014 it pings the
              owner&apos;s phone directly with whatever you need.
            </li>
          </ol>
        </section>
        ...
        <section className="ios-glass rounded-3xl p-5">
          ...
          <ul className="space-y-3 text-[14px] text-[#F0E2C2]/85 leading-relaxed">
            <li>
              ...
              GPS apps sometimes try to route you via Sunny Creek Rd \u2014
              that\u2019s the wrong way and dead-ends in a neighbor\u2019s subdivision.{" "}
            ...
            <li>
              ...
              Each stay gets a unique keypad code, sent in your welcome email
              from the booking system. Codes rotate so the next guest can\u2019t
              reuse yours.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Parking.</span>{" "}
              Pull up directly in front of your cabin on Ridge Cabin Rd. Drive
              slowly on the gravel \u2014 there\u2019s wildlife, kids, and a few
              hairpins.
            </li>
          </ul>
        </section>
        ...
        <section className="ios-glass rounded-3xl p-5">
          ...
          <p className="text-[13px] text-[#F0E2C2]/75 leading-relaxed mb-3">
            Each cabin has a dedicated page with its wifi card, photos, and quick
            links \u2014 there\u2019s a printed QR code on each cabin door that opens it.
          </p>
        ...
        <section className="ios-glass rounded-3xl p-5">
          ...
          <p className="text-[14px] text-[#F0E2C2]/85 leading-relaxed mb-3">
            Two networks during the current upgrade \u2014 try the Guest network first,
            fall back to the other if signal is weak.
          </p>
          ...
          <p className="text-[12px] text-[#F0E2C2]/55 leading-snug mt-3">
            We\u2019re rolling out a single hardwired Starlink network soon \u2014
            this card will update with the new credentials once it\u2019s live.
          </p>
          <p className="text-[12px] text-[#F0E2C2]/55 leading-snug mt-2">
            <span className="text-[#F0E2C2]/85">Cell coverage</span> can be spotty
            past the lakes and out at The 13. Install this app to home screen and
            the property map will work without a signal.
          </p>
        </section>
        ...
        <section className="ios-glass rounded-3xl p-5">
          ...
          <p className="text-[14px] text-[#F0E2C2]/85 leading-relaxed mb-3">
            Tap <em>Send feedback</em> on the home page, pick a category, and
            send. It pings the owner\u2019s phone directly:
          </p>
          <ul className="space-y-1.5 text-[13.5px] text-[#F0E2C2]/85 leading-relaxed">
            <li><span className="text-[#cdac7d] font-semibold">Firewood</span> \u2014 running low, or restocked but need a delivery to a specific firepit.</li>
            <li><span className="text-[#cdac7d] font-semibold">Towels / linens</span> \u2014 extras for the cabin.</li>
            <li><span className="text-[#cdac7d] font-semibold">Broken / needs repair</span> \u2014 anything from a leaky faucet to a tripped breaker.</li>
            <li><span className="text-[#cdac7d] font-semibold">Trash</span> \u2014 full bins, or you\u2019re not sure where pickup is.</li>
            <li><span className="text-[#cdac7d] font-semibold">Other request</span> \u2014 anything else (more firewood, weird sound from the well, whatever).</li>
            <li><span className="text-[#cdac7d] font-semibold">Just a note</span> \u2014 ideas, compliments, suggestions for the app.</li>
          </ul>
        ...
        <section className="ios-glass rounded-3xl p-5">
          ...
          <ul className="space-y-3 text-[14px] text-[#F0E2C2]/85 leading-relaxed">
            <li>
              ...
              for difficulty + notes, or <Link href="/map" className="text-[#cdac7d] underline">open the map</Link>.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Two lakes, beach, and a dock.</span>{" "}
              The main lake has the pavilion, fishing dock, and a beach firepit.
              Swim at your own risk \u2014 the water\u2019s warm in late summer.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Firepits.</span>{" "}
              The lake-beach firepit and the upper-ridge firepit both have
              stacked wood. Light it, enjoy, drown it before bed. If wood\u2019s
              low, hit <em>Send feedback \u2192 Firewood</em>.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Horses.</span>{" "}
              The horse pasture sits east of the cabins (the Horse Pasture Trail
              walks the woodline). Feel free to stop and say hello \u2014 just
              don\u2019t feed them.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Wildlife.</span>{" "}
              Deer, geese, ducks, wild turkey, the occasional bobcat. Give them
              space. Dogs welcome on-leash. <em>(Pet policy: confirm in your booking.)</em>
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Find the bear.</span>{" "}
              There are wooden bear and bobcat carvings tucked around the
              property \u2014 Big Lou by the lake pavilion is the easiest to spot.
              See if the kids can find them all.
            </li>
          </ul>
        </section>
        ...
        <section className="ios-glass rounded-3xl p-5">
          ...
          <ul className="space-y-2.5 text-[14px] text-[#F0E2C2]/85 leading-relaxed">
            <li>
              ...
              Out of respect for the wildlife and the property\u2019s natural
              quiet, keep outdoor music + volume reasonable after 10pm.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Trash &amp; recycling.</span>{" "}
              Each cabin has bins. <em>Pickup day + bin location coming soon.</em> If
              you\u2019re unsure, send feedback and we\u2019ll guide you.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Linens.</span>{" "}
              Fresh sheets and towels are stocked. Leave used ones in the
              hamper at the end of your stay \u2014 no need to wash.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Check-out.</span>{" "}
              Time + checklist are in your booking confirmation. Basic ask: lock
              up, run the dishwasher, kill the firepit.
            </li>
          </ul>
        </section>
        ...
        <section className="ios-glass rounded-3xl p-5">
          ...
          <ul className="space-y-3 text-[14px] text-[#F0E2C2]/85 leading-relaxed">
            <li>
              ...
              Use the feedback widget above. Pick the right category and you\u2019ll
              get a fast response.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Urgent (broken pipe, power out, fire).</span>{" "}
              Call/text the owner. Number is in your welcome email.
            </li>
            <li>
              <span className="font-semibold text-[#F0E2C2]">Emergency.</span>{" "}
              Dial <span className="font-mono">911</span>. The property address
              for first responders is on the front of your welcome email \u2014
              keep it handy.
            </li>
          </ul>
        </section>
        ...
        <p className="text-center text-[11px] text-[#F0E2C2]/40 pt-2">
          This manual is a living document. Things may change \u2014 if anything\u2019s
          out of date, send a quick note.
        </p>
      </div>
    </main>
  );
