...
const ICON_PATHS: Record<string, string> = {
  ...
  warn: '<g fill="none" stroke="#F0E2C2" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3.5l9.5 16h-19z" fill="#B23A1F"/><line x1="12" y1="10" x2="12" y2="14.5" stroke-width="2.4"/><circle cx="12" cy="17.2" r="0.4" fill="#F0E2C2" stroke="none"/></g>',
