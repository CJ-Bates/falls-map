...
const ICON_PATHS: Record<string, string> = {
  ...
  entrance: '<g fill="none" stroke="#F0E2C2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="11" width="4" height="10"/><rect x="16" y="11" width="4" height="10"/><path d="M4 11l8-7 8 7"/><path d="M10 21v-5h4v5"/></g>',
  warn: '<g fill="none" stroke="#F0E2C2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l10 18H2z" fill="#B23A1F" stroke-width="1.8"/><line x1="12" y1="9" x2="12" y2="13.5" stroke-width="2.4"/><circle cx="12" cy="17" r="1.1" fill="#F0E2C2" stroke="none"/></g>',
